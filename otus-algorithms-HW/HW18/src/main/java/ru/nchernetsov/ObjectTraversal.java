...
import static ru.nchernetsov.reflection.ReflectionHelper.getFieldValue;

/**
 * Класс для обхода всех полей заданного объекта
 */
class ObjectTraversal {

    /**
     * Преобразовать заданный объект в JSON-строку
     *
     * @param object объект
     * @return JSON-представление объетка
     */
    ...
    // Методы обхода полей объекта разного типа
